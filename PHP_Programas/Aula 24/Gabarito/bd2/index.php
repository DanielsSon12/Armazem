...
<hr><a href="filmeInserir.php">INSERIR NOVO FILME</a><hr>
<table border="1">
    <thead>
    ...
    echo "<td><a href=filmeExcluirBd.php?id={$filme['id']} >[EXCLUIR]</a>
    <a href=filmeObterBd.php?id={$filme['id']} >[ALTERAR]</td>";
    echo "</tr>";
    }?>   
    </tbody>
</table>
